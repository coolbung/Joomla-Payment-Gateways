...
<form action="<?php echo JURI::base().'index.php?option=com_jticketing&processor=linkpoint&task=processpayment' ?>" method="post">
	
	<table class="userlist">	
		<tr>
			<td>&nbsp;</td>
			<td align="right"><?php echo JText::_('* - Required Fields'); ?></td>
		</tr>				
		<tr><td colspan="2"><h3><?php echo JText::_('Credit Card Payment'); ?></h3></td></tr>
		<tr>
	...
	<input type="hidden" name="tid" value="<?php echo $session->get('sticketid');?>" />
</form>
